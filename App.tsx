    ...
    <div className="min-h-screen bg-slate-900 text-gray-200 flex flex-col font-sans">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {error && (
            <div className="relative mt-8 bg-red-900/50 border border-red-700 text-red-300 px-4 py-3 rounded-lg text-center">
              {error}
              <button onClick={() => setError(null)} className="absolute top-2 right-2 p-1 text-red-300 hover:text-white">
                <XIcon />
              </button>
            </div>
          )}
